...
export default function Home() {
  return (
    <div className="pt-10 pb-4 px-2 md:px-32 flex flex-col gap-8 md:gap-20">
      {/* Landing Page */}
      <div className="flex  items-center gap-20">
        <div className="flex-1 flex flex-col gap-2 ">
          <h1 className="md:text-xl font-bold">Halo, Kami Adalah</h1>
          <h1 className="text-2xl md:text-4xl font-bold ">Interior Designer</h1>
          <h3 className=" md:text-xl font-bold ">
            Kami Menyediakan <span className="text-gold">Berbagai Macam Desain</span>{" "}
          </h3>

          <p className="md:mt-10 max-w-[460px] text-sm md:text-base">
        ...
        {/* IMAGE GRID */}
        <div className="hidden md:grid grid-cols-2 grid-rows-2 gap-5 h-[400px] flex-1">
          {/* BESAR */}
      ...
      {/* Tentang Kami */}
      <div className="flex flex-wrap md:flex-nowrap gap-4 md:gap-24 items-center justify-center">
        <img src="/img/Logo.jpg" className="w-[100px] md:w-[300px] rounded-full border-2 object-cover" />
      ...
      {/* Kontak Kami */}
      <div className="flex flex-col gap-6 px-2 md:px-24">
        <h1 className="text-2xl md:text-3xl font-bold text-center">
          <span className="text-gold">Kontak</span> kami
        </h1>
        <div className="flex justify-center gap-10">
          <div className="flex-1 flex flex-col gap-4">
            <p className="text-sm md:text-base">Jl. Melati No.49, Kepanjen Kidul, Kec. Kepanjenkidul, Kota Blitar, Jawa Timur 66111</p>
          ...
          <div className="hidden md:flex flex-1 bg-gray-300 w-full rounded-lg"></div>
        </div>
      </div>
      {/* Footer */}
      <Footer/>
